...
class TestDecompressor_stream_writer_fuzzing(unittest.TestCase):
    ...
    @hypothesis.given(
        ...
        level=strategies.integers(min_value=1, max_value=3),
...
class TestDecompressor_copy_stream_fuzzing(unittest.TestCase):
    ...
    def test_read_across_frames(
        ...
        r, w = dctx.copy_stream(
            compressed, dest, read_size=read_size, write_size=write_size
        )
